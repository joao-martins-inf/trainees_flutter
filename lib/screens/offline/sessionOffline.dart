...
class SessionOffline extends StatefulWidget {
  static Future<void> navigatorPush(BuildContext context) async {
    return Navigator.push<void>(
      context,
      MaterialPageRoute(
        builder: (_) => SessionOffline(),
      ),
    );
  }

  @override
  _SessionOfflineState createState() => _SessionOfflineState();
}

class _SessionOfflineState extends State<SessionOffline> {
  final _isHours = true;
